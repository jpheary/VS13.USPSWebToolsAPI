...
namespace VS13.USPS {
    ...
    public class USPSGateway {
        ...
        public TrackResponse TrackRequest(string itemNumber) {
            //
        ...
        public TrackFieldResponse TrackFieldRequest(string itemNumber) {
            //
        ...
        public TrackFieldResponse TrackFieldRequests(string[] itemNumbers) {
            //
            TrackFieldResponse response = new TrackFieldResponse();
            USPSWebToolsClient client = new USPSWebToolsClient();
            try {
